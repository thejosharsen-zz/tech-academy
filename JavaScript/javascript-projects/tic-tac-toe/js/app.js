...
let activePlayer = 'X';
// This array stores an array of movies. We use this o determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/chrome.png")';
        // Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            // If activePlayer is equal to 'O', the o.png is placed in html.
            select.style.backgroundImage = 'url("images/safari.png")';
        }
        ...
        // This condition checks to see if it computers turn.
        if (activePlayer === 'O') {
...
function checkWinConditions() {
    ...
    // X 6, 7, 8 condition
    else if (arrayIncludes('5X', '6X', '7X')) {drawWinLine(50, 508, 558, 508); }
    // X 0, 3, 6 condition
    ...
    // 0 6, 7, 8 condition
    else if (arrayIncludes('5O', '6O', '7O')) {drawWinLine(50, 508, 558, 508); }
    // 0 0, 3, 6 condition
